...
const routes = [
  ...
  { path: '/borrow', name: 'borrow', component: BorrowPage, meta: { requiresAuth: true, roles: ['admin', 'petugas', 'member'] } },
  { path: '/ebooks', name: 'ebooks', component: EbooksPage, meta: { requiresAuth: true, roles: ['member'] } },
